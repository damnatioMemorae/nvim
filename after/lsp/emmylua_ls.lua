...
local _libs = { vim.env.VIMRUNTIME, "${3rd}/luv/library", "${3rd}/busted/library" }
...
return {
        ...
        settings     = {
                emmylua = {
                        ...
                        doc            = { syntax = "md" },
                        runtime        = { version = "LuaJIT", requireLikeFunctions = { "safeRequire", " safeRequire" } },
                        workspace      = {
                                -- library = vim.api.nvim_get_runtime_file("", true),
                                library = _libs,
                        },
                        strict         = { requirePath = false, typeCall = false },
                        ...
                        references     = { enable = true, fuzzySearch = true, shortStringSearch = true },
                        hover          = { enable = true, customDetail = 255 },
                        format         = {
                                externalTool = {
