...
local function inclineInstalled()
        return not pcall(require, "incline")
end
...
return {
        ...
        opts         = {
                bar     = {
                        ...
                        sources       = function(buf, _)
                                ...
                                if bo[buf].ft == "neo-tree" or bo[buf].ft == "Outline" then return {} end
                                if bo[buf].ft == "markdown" then return { sources.path, sources.markdown } end
                                if bo[buf].buftype == "terminal" then return { sources.terminal } end
                ...
                menu    = {
                        ...
                        win_configs      = { style = "minimal", border = Border.Default.None, zindex = 3000 },
                        keymaps          = {
                                ["<Esc>"] = "<C-w>q",
                                ["h"]     = "<C-w>q",
                                ["i"]     = function()
                                ...
                                ["l"]     = function()
                                        ...
                                        -- local cursor    = vim.pos.cursor(menu.win)
                ...
                icons   = {
                        enable = true,
                        ui     = {
                                bar  = { separator = " " .. arrows.rightBig .. " ", extends = " " .. misc.ellipsis .. " " },
                                menu = { separator = " ", indicator = misc.squareFilled .. " " },
                        },
                },
                sources = {
                        path = {
        ...
        config       = function(_, opts)
                ...
                ui.select = require "dropbar.utils.menu".select
        end,
}
