...
return {
        ...
        opts         = {
                ...
                icons   = {
                        enable = true,
                        ui     = {
                                bar  = { separator = " " .. Config.Icons.arrows.rightArrow .. " ", extends = " " .. Config.Icons.misc.ellipsis .. " " },
                                menu = { separator = " ", indicator = Config.Icons.misc.squareFilled .. " " },
                        },
                        kinds  = { symbols = addSpace(Config.Icons.symbolKinds) },
                },
        },
}
