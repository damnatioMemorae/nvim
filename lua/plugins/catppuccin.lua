...
local customCol = function(C)
        return {
                ...
                borderBottom               = { link = "borderStyle" },
                borderLeft                 = { link = "borderStyle" },
                borderRight                = { link = "borderStyle" },
                borderTopEmpty             = { link = "borderStyle" },
                borderBottomEmpty          = { link = "borderStyle" },
                borderLeftEmpty            = { link = "borderStyle" },
                borderRightEmpty           = { link = "borderStyle" },
                borderStyleNone            = { link = "borderStyle" },
