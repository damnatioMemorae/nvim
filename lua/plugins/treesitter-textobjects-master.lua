...
return { -- treesitter-based textobjs
        ...
        keys         = {
                ...
                { -- `F` - FUNCTION PREV
                        ...
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Function .. "Goto prev function",
                },
                { -- `f` - FUNCTION NEXT
                        "<A-f>",
                        "<cmd>TSTextobjectGotoNextStart @function.name<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Function .. "Goto next function",
                },
                { -- `O` - CONDITION PREV
                        "<A-O>",
                        "<cmd>TSTextobjectGotoPreviousStart @conditional.inner<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.IfStatement .. "Goto prev condition",
                },
                { -- `o` - CONDITION NEXT
                        "<A-o>",
                        "<cmd>TSTextobjectGotoNextStart @conditional.inner<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.IfStatement .. "Goto next condition",
                },
                { -- `C` - CALL PREV
                        "<A-C>",
                        "<cmd>TSTextobjectGotoPreviousStart @call.outer<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Call .. "Goto prev call",
                },
                { -- `c` - CALL NEXT
                        "<A-c>",
                        "<cmd>TSTextobjectGotoNextStart @call.outer<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Call .. "Goto next call",
                },
                { -- `U` - LOOP PREV
                        "<A-U>",
                        "<cmd>TSTextobjectGotoPreviousStart @loop.outer<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Repeat .. "Goto prev loop",
                },
                { -- `u` - LOOP NEXT
                        "<A-u>",
                        "<cmd>TSTextobjectGotoNextStart @loop.outer<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Repeat .. "Goto next loop",
                },
                { -- `S` - ASSIGNMENT PREV
                        "<A-S>",
                        "<cmd>TSTextobjectGotoPreviousStart @assignment.lhs<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Variable .. "Goto prev assignment",
                },
                { -- `s` - ASSIGNMENT NEXT
                        "<A-s>",
                        "<cmd>TSTextobjectGotoNextStart @assignment.lhs<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Variable .. "Goto next assignment",
                },
                { -- `V` - VALUE PREV
                        "<A-V>",
                        "<cmd>TSTextobjectGotoPreviousStart @assignment.rhs<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Value .. "Goto prev value",
                },
                { -- `v` - VALUE NEXT
                        "<A-v>",
                        "<cmd>TSTextobjectGotoNextStart @assignment.rhs<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Value .. "Goto next value",
                },
                { -- `T` - TYPE PREV
                        "<A-T>",
                        "<cmd>TSTextobjectGotoPreviousStart @assignment.outer<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Type .. "Goto prev type",
                },
                { -- `t` - TYPE NEXT
                        "<A-t>",
                        "<cmd>TSTextobjectGotoNextStart @assignment.outer<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Type .. "Goto next type",
                },
                { -- `A` - PARAMETER PREV
                        "<A-A>",
                        "<cmd>TSTextobjectGotoPreviousStart @parameter.inner<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Parameter .. "Goto prev parameter",
                },
                { -- `a` - PARAMETER NEXT
                        "<A-a>",
                        "<cmd>TSTextobjectGotoNextStart @parameter.inner<CR>",
                        mode = modes,
                        desc = Config.Icons.symbolKinds.Parameter .. "Goto next parameter",
                },
                { -- `{` - PARAMETER PREV SWAP
                        "<A-{>",
                        "<cmd>TSTextobjectSwapPrevious @parameter.inner<CR>",
                        mode = { "n", "x", "o" },
                        desc = Config.Icons.symbolKinds.Parameter .. "Swap prev parameter",
                },
                { -- `}` - PARAMETER NEXT SWAP
                        "<A-}>",
                        "<cmd>TSTextobjectSwapNext @parameter.inner<CR>",
                        mode = { "n", "x", "o" },
                        desc = Config.Icons.symbolKinds.Parameter .. "Swap next parameter",
                },
                --]]
                ...
                { -- `/` REGEX OUTER
                        ...
                        mode = { "x", "o" },
                        desc = Config.Icons.symbolKinds.Regex .. "outer regex",
                },
                { -- `/` REGEX INNER
                        "i/",
                        "<cmd>TSTextobjectSelect @regex.inner<CR>",
                        mode = { "x", "o" },
                        desc = Config.Icons.symbolKinds.Regex .. "inner regex",
                },
                { -- `f` FUNCTION OUTER
                        "a" .. textObj.func,
                        "<cmd>TSTextobjectSelect @function.outer<CR>",
                        mode = { "x", "o" },
                        desc = Config.Icons.symbolKinds.Function .. "outer function",
                },
                { -- `f` FUNCTION INNER
                        "i" .. textObj.func,
                        "<cmd>TSTextobjectSelect @function.inner<CR>",
                        mode = { "x", "o" },
                        desc = Config.Icons.symbolKinds.Function .. "inner function",
                },
                { -- `o` CONDITION OUTER
                        "a" .. textObj.condition,
                        "<cmd>TSTextobjectSelect @condition.outer<CR>",
                        mode = { "x", "o" },
                        desc = Config.Icons.symbolKinds.IfStatement .. "outer condition",
                },
                { -- `o` CONDITION INNER
                        "i" .. textObj.condition,
                        "<cmd>TSTextobjectSelect @condition.outer<CR>",
                        mode = { "x", "o" },
                        desc = Config.Icons.symbolKinds.IfStatement .. "inner condition",
                },
                { -- `l` CALL OUTER
                        "a" .. textObj.call,
                        "<cmd>TSTextobjectSelect @call.outer<CR>",
                        mode = { "x", "o" },
                        desc = Config.Icons.symbolKinds.Call .. "outer call",
                },
                { -- `l` CALL INNER
                        "i" .. textObj.call,
                        "<cmd>TSTextobjectSelect @call.inner<CR>",
                        mode = { "x", "o" },
                        desc = Config.Icons.symbolKinds.Call .. "inner call",
                },
                --]]
                ...
                ---[[ REPEATABLE ACTIONS
                {
                        ...
                        mode = { "n", "v", "x" },
                        desc = Config.Icons.symbolKinds.Call .. "󰑖 Repeat to Prev",
                },
                {
                        "'",
                        "<cmd>TSTextobjectRepeatLastMoveNext<CR>",
                        mode = { "n", "v", "x" },
                        desc = Config.Icons.symbolKinds.Repeat .. "󰑖 Repeat to Next",
                },
                --]]
