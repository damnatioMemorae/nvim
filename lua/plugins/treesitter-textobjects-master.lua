...
return {
        ...
        keys         = {
                ...
                { -- `a/` REGEX OUTER
                        ...
                        mode = { "x", "o" },
                        desc = Icons.Kinds.Regex .. "outer regex",
                },
                { -- `i/` REGEX INNER
                        "i/",
                        "<cmd>TSTextobjectSelect @regex.inner<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.Regex .. "inner regex",
                },
                { -- `af` FUNCTION OUTER
                        "a" .. textObj.func,
                        "<cmd>TSTextobjectSelect @function.outer<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.Function .. "outer function",
                },
                { -- `if` FUNCTION INNER
                        "i" .. textObj.func,
                        "<cmd>TSTextobjectSelect @function.inner<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.Function .. "inner function",
                },
                { -- `ao` CONDITION OUTER
                        "a" .. textObj.condition,
                        "<cmd>TSTextobjectSelect @condition.outer<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.IfStatement .. "outer condition",
                },
                { -- `io` CONDITION INNER
                        "i" .. textObj.condition,
                        "<cmd>TSTextobjectSelect @condition.outer<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.IfStatement .. "inner condition",
                },
                { -- `al` CALL OUTER
                        "a" .. textObj.call,
                        "<cmd>TSTextobjectSelect @call.outer<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.Call .. "outer call",
                },
                { -- `il` CALL INNER
                        "i" .. textObj.call,
                        "<cmd>TSTextobjectSelect @call.inner<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.Call .. "inner call",
                },
                { -- `aa` PARAMETER OUTER
                        "aa",
                        "<cmd>TSTextobjectSelect @parameter.outer<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.Call .. "outer parameter",
                },
                { -- `ia` PARAMETER INNER
                        "ia",
                        "<cmd>TSTextobjectSelect @parameter.inner<CR>",
                        mode = { "x", "o" },
                        desc = Icons.Kinds.Call .. "inner parameter",
                },
                --]]
                ...
                ---[[ REPEATABLE ACTIONS
                {
                        ...
                        mode = { "n", "v", "x" },
                        desc = Icons.Kinds.Call .. "󰑖 Repeat to Prev",
                },
                {
                        "'",
                        "<cmd>TSTextobjectRepeatLastMoveNext<CR>",
                        mode = { "n", "v", "x" },
                        desc = Icons.Kinds.Repeat .. "󰑖 Repeat to Next",
                },
                --]]
